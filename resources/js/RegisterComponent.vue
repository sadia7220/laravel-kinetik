    ...
    <div v-if="!secrets.length" class="row pr-10">
        <form action="/dash" @submit.prevent="handleLogin">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="exampleInputName" placeholder="Name" v-model="formData.name"/>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="password" class="form-control" id="exampleInputPassword2" placeholder="Confirm Password" v-model="formData.password_confirmation"/>
            </div>
    ...
    methods: {
        handleLogin() {
            ...
            axios.get('/sanctum/csrf-cookie').then(response => {
                axios.post('http://127.0.0.1:8000/api/user/register', this.formData).then(response => {
